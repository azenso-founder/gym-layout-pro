        ...
        {profile && (
          <div className="mr-4">
            {profile.plan === 'free' ? (
              <Link
                href="/upgrade"
                className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium bg-zinc-800 text-zinc-400 hover:bg-orange-500/10 hover:text-orange-400 transition-colors"
              >
                Free • Upgrade ✨
              </Link>
            ) : (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium bg-orange-500/10 text-orange-400">
                Pro ✓
              </span>
            )}
          </div>
